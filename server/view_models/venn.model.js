var textSection = {
    ...
    text: "During the first weeks working for Betsson I was told to choose a value word and thought " +
        ...
        "The ambition is to be a truly cross-functional web developer in order to flow with " +
        "ever changing situations you face as a web developer. " +
        "With a Bachelor degree in programming from Linkoping university I went on to finish a " +
        ...
        "The new paradigm is 'Per Programming' ..."
};

var vennData = {
    W: "Joy in development",
    N: "UX geek",
